...
export type Order = {
  ...
  status?: "pending" | "paid" | "shipped" | "deliverd" | "cancelled";
  orderDate?: string;
};
...
export type MY_ORDERS_QUERYResult = Array<{
  ...
  currency?: string;
  amountDiscount?: number;
  status?: "cancelled" | "deliverd" | "paid" | "pending" | "shipped";
  orderDate?: string;
}>;
...
// Query: *[    _type == "ProductType" && name match    $searchParam     ]    | order(name desc)
...
// Query: *[_type == "sale"&& isActive == true&& couponCode == $couponCode] |order(va1idFrom desc) {_id,title,description,discountAmount,couponCode,validFrom,validUntil,isActive}[0]
